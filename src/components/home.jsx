  ...
  return <ScrollableAnchor id={"home"}>
      <div className="modular-row" style={{justifyContent: 'center'}}>
        <div className="card-content">
          ...
          <p>
            <span className="c-grey">··</span>
            <span className="c-blue">position</span>:<span className="c-grey">·</span>
            <span className="c-orange">$ui-ux-developer</span>;
          </p>
          <p>
            <span className="c-grey">··</span>
            <span className="c-blue">display</span>:<span className="c-grey">·</span>
          ...
          <div className="extras">
            ...
            <p>
              <span className="c-grey">··</span>
              <span className="c-blue">clear</span>:<span className="c-grey">·</span>
            ...
            <p>
              ...
              <span className="c-grey">·</span>+<span className="c-grey">·</span>
